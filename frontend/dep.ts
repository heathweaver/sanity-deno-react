...
// Module '"https://cdn.skypack.dev/react-router-dom"' has no exported member 'StaticRouter'. Did you mean to use 'import StaticRouter from "https://cdn.skypack.dev/react-router-dom"' instead?